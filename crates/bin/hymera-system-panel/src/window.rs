use dioxus::desktop::{tao::platform::unix::WindowBuilderExtUnix, LogicalSize, WindowBuilder};
...
fn setup() {
    ...
    const SYSTEM_PANEL_STYLE_RULE: &str = "norounding, noborder, sticky, class:^(hymera-system-panel)$";
    // const SYSTEM_PANEL_STYLE_RULE: &str = "nofocus, norounding, class:^(hymera-system-panel)$"; // disabled due development
...
pub fn create() -> WindowBuilder {
    ...
    let panel_size = LogicalSize::new(monitor.width as f32 / monitor.scale, 25.0);
